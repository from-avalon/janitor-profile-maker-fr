  ...
  var GROUPS = [
    ...
    },
    {
      ...
      controls: [
        ...
        len('.pp-top-bar-logo img', 'width', 'Logo width', { max: 100 }),
        len('.pp-top-bar-logo img', 'height', 'Logo height', { max: 100 }),
        text('.pp-top-bar-logo img', 'filter', 'Logo filter', 'drop-shadow(0 0 8px #a855f7)'),
        font('.pp-top-bar-tabs', 'Navigation font'),
        col('.pp-top-bar-tabs', 'color', 'Navigation colour'),
        ...
        grad('.pp-top-bar-notifications-popover', 'background', 'Notifications panel fill'),
        col('.pp-top-bar-notifications-popover', 'border-color', 'Notifications panel border'),
        col('.pp-top-bar-notifications-item', 'color', 'Notification text'),
